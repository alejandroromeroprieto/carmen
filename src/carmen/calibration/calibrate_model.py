...
from carmen.calibration.utils import (
    Normalizer,
...
from carmen.utils import Data, make_all_dirs
...
OUT_DIR = CWD + "/src/carmen/calibration/calibration_results"

# Path and prefix to all input data files
PREFIX = CWD + "/src/carmen/data/scenarios/"
PREFIX_DETRENDED = CWD + "/src/carmen/data/scenarios/detrended_wrt_decade/"
